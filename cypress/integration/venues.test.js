describe("Minimal Venue mutations", () => {
  beforeEach(() => {
  ...
  it("can add, edit and delete venue", () => {
    cy.visit("/shows");
...
describe("Maximal Venue mutations", () => {
  beforeEach(() => {
    // authenticate, adapted from
    // https://docs.cypress.io/guides/testing-strategies/auth0-authentication#Custom-Command-for-Auth0-Authentication
    cy.loginByAuth0Api(
...
describe("make sure changed venue name is reflected in show display", () => {
  beforeEach(() => {
    // authenticate, adapted from
    // https://docs.cypress.io/guides/testing-strategies/auth0-authentication#Custom-Command-for-Auth0-Authentication
    cy.loginByAuth0Api(
    ...
    // make sure beforeEach doesn't return until db reset is finished
    // TODO: not waiting T.T
    return cy.task("db:reset").then(() => null);
  });
  it("updates with show display updated venue name", () => {
